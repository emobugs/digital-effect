			...
			<div className="max-w-2xl mx-auto px-4 py-14">
				...
				<div className="space-y-6 text-[15px] leading-relaxed text-gray-300">
					...
					<section>
						...
						<p>Чрез партньорската програма (/partners): име, телефон, имейл, роля и фирма на партньора, кой партньор го е поканил, както и списък на бизнесите, които е препоръчал, и начислените му суми. Ако сте попълнили анкетата през партньорски линк, записваме кода на партньора към Вашето запитване и той вижда в кабинета си името на бизнеса Ви и дали сте станали клиент — не и отговорите Ви или условията по договора.</p>
					</section>
					<section>
					...
					<section>
						...
						<p>Сайтът не използва рекламни или проследяващи бисквитки. Единственото, което пазим в браузъра Ви, е партньорският код от линк с „?p=“ (до 90 дни, за да се зачете препоръката при по-късно попълване) и, в кабинета на партньора, кодът и телефонът му за текущата сесия. Можете да ги изтриете от настройките на браузъра.</p>
					</section>
				</div>
			</div>
		</main>
