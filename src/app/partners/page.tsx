...
import { PROGRAM, ROLES, tierRate, pct, eur } from "./program";
...
const STEPS = [
	...
	["Печелите 12 месеца", "Той попълва анкетата ни, ние работим, Вие получавате процент от всяко негово месечно плащане."],
];
...
export default function PartnersPage() {
	...
	const tiers = useMemo(() => [...PROGRAM.tiers].sort((a, b) => a.min - b.min), []);
